...
![20260118161746.png](assets/20260118161746.png)
!![](assets/20260118161806.png)

!![](assets/20260118161838.png)
Définition du nom sur srv-glpi et du domaine sur rue25.com.
!![](assets/20260118162259.png)
Après création du compte admin, création de la partition.
!![](assets/20260118162337.png)
...
!![](assets/20260118162825.png)
L'os démarre après l'utilitaire d'installation :
!![](assets/20260118163125.png)
Je vérifie si ssh tourne tout de suite pour pouvoir continuer depuis mon propre terminal:
!![](assets/20260118163159.png)
SSH fonctionnel, prouvé par la possibilité de m'y connecter depuis mon PC.
!![](assets/20260118163658.png)
Installation de sudo via su- puis ajoute de l'utilisateur au sudoer
Ensuite je vais chercher la doc de GLPI ici :
...
Commeçons par l'installation des packets dependencies du brief:
sudo apt install apache2 mariadb-server php php-mysql php-ldap php-xml php-gd php-mbstring php-curl php-intl php-zip php-bz2 -y
...
Ensuite téléchargement de l'archive avec wget  https://github.com/glpi-project/glpi/releases/download/10.0.12/glpi-10.0.12.tgz 

Petit détour par man tar pour identifier la bonne commande d'extraction puis
tar -xvzf glpi-10.0.12.tgz 

 Déplacement du fichier : sudo mv glpi /var/www/glpi
